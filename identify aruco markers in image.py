...
def read_inf(ids, i, data, rvecs, tvecs):
    ...
    id = [0, 1, 10, 11, 12, 13, 14, 15, 5, 3, 4, 2]
    location = ['center', 'palm', 'bottom_left', 'top_left', 'top_right', 'bottom_right', 'end_effector', 'object', 'finger_1_prox', 'finger_1_dist', 'finger_2_prox', 'finger_2_dist']
    dict={}
    ...
    data_save = [name, trans[0], trans[1], trans[2], math.degrees(roll_marker), math.degrees(pitch_marker), math.degrees(yaw_marker)]
